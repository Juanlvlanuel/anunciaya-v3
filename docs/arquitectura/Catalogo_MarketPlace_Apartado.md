...
> **Estado:** Backend completo. Frontend: página pública + Apartar + gestión privada + configuración + Alta Rápida (carga masiva) completos. Pendiente: lock BD contra carrera de apartados simultáneos + QA de expiración por cron.
...
> Racional de producto: sesión de planeación 2026-08-12. Rediseño a modelo de 2 estados: sesión 2026-08-16. Chat directo automático al apartar: sesión 2026-08-17. Alta Rápida MarketPlace: sesión 2026-08-18.
