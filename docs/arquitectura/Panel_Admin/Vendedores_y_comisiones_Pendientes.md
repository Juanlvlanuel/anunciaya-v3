...
| **D11** | ¿Dónde se edita la escalera? | El dato vive en `configuracionSistema` (helper `obtenerConfig`). La **UI de edición** puede estar aquí (sección "Escalera") o en Configuración. Recomendación: editarla **aquí** (donde se entiende su efecto) y que Configuración la lea. | ✅ decidido (16 Jun) |
