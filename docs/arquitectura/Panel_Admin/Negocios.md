...
AnunciaYA cobra a cada negocio una **membresía de $864 al mes**. A cambio, el negocio
...
- **Membresía:** la suscripción de $864/mes que paga el negocio para estar en AnunciaYA.
...
> *Ejemplo: Don Beto, dueño de una taquería, paga $864 por un mes más. El gerente abre su
> ficha, pulsa "Registrar pago", pone "efectivo, $864, 1 mes" y listo: el negocio queda al
...
> acepta y le paga $864 en efectivo por su primer mes.*
...
apellidos, **correo dos veces** para evitar errores, teléfono), y el cobro (efectivo, $864,
...
- `docs/arquitectura/Pagos_Suscripciones.md` — membresía $864/mes, Stripe, los dos ejes de estado, "Registrar pago" Opción A.
