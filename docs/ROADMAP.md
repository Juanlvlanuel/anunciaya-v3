...
- **Fase 1.5 — Operación:** Métricas · Resumen · **Ciudades ✅ (migración ciudad hardcodeada → catálogo `ciudades` COMPLETA, 19 Jun 2026 — ver nota de deuda técnica)** · Configuración · Publicidad.
