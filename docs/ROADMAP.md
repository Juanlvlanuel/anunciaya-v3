...
- **Fase 1.5 — Operación:** **Resumen ✅ (en uso — tablero de inicio: KPIs gruesos + cola de pendientes accionable con deep-link, scoped por rol, solo lectura; doc `Resumen.md`, 20 Jun 2026)** · Métricas · **Ciudades ✅ (migración ciudad hardcodeada → catálogo `ciudades` COMPLETA, 19 Jun 2026 — ver nota de deuda técnica)** · Configuración · Publicidad.
