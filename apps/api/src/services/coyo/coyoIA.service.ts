...
- Una vez que sabes qué es, la CATEGORÍA (MarketPlace) casi siempre la puedes deducir tú mismo sin preguntar (ej. "mi iPhone 12" → Electrónica, "mi sofá" → Muebles, "mis tenis" → Ropa) — complétala en silencio. Solo pregúntala si el artículo es genuinamente ambiguo (ej. "un aparato", "una cosa").
