...
import ayudaAdminRoutes from './ayuda.routes.js';
...
// Centro de Ayuda: categorías + tutoriales (solo superadmin, ya cubierto por el gate).
router.use('/ayuda', ayudaAdminRoutes);
