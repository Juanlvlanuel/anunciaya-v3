...
export const notificaciones = pgTable("notificaciones", {
	...
	// + 'dinamica_pago_confirmado' agregado en la migración
...
export const dinamicas = pgTable("dinamicas", {
	...
	// Número con el que arranca la numeración de boletos (ago-2026) — el
	// organizador lo elige libremente al crear (default 1, mismo
	// comportamiento histórico); el número final se calcula siempre como
	// `numeroBoletoInicial + numeroTotalBoletos - 1`, nunca se guarda aparte.
	numeroBoletoInicial: integer("numero_boleto_inicial").default(1).notNull(),
