...
export const queryKeys = {
  ...
  negocios: {
    ...
    paquetesPromo: () => ['negocios', 'paquetes-promo'] as const,
  ...
  suscripciones: {
    ...
    historial: (filtros: { estado?: string; pagina?: number }) => ['suscripciones', 'historial', filtros] as const,
  ...
  ayuda: {
    all: () => ['ayuda'] as const,
    contenido: () => ['ayuda', 'contenido'] as const,
  },
