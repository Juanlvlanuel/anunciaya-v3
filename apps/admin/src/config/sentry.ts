/**
 * sentry.ts (admin / Panel)
 * =========================
 * Inicialización de Sentry (error tracking) para el Panel de Administradores.
 *
 ...
 *
 * Ubicación: apps/admin/src/config/sentry.ts
 */
...
export function inicializarSentryPanel(): void {
