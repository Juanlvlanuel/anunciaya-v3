...
import { ChevronLeft, X, ImagePlus, AlertCircle, Loader2 } from 'lucide-react';
...
export function PaginaPublicarArticulo() {
    ...
    useEffect(() => {
        if (hidratado) return;
        const storageKey = `${STORAGE_PREFIX_WIZARD}${articuloId ?? 'nuevo'}`;
    ...
    const erroresPaso1 = useMemo(() => {
        ...
        if (datos.titulo.length > TITULO_MAX)
    ...
    const erroresPaso2 = useMemo(() => {
        ...
        if (datos.descripcion.length > DESCRIPCION_MAX)
    ...
    const handleAtras = () => {
        if (pasoActual === 1) {
            if (window.confirm('¿Salir sin publicar? Los datos se conservan en este navegador.')) {
    ...
    return (
        <div data-testid="pagina-publicar-articulo" className="min-h-full bg-slate-50 pb-24">
            ...
            <div className="lg:mx-auto lg:max-w-7xl lg:px-6 lg:py-6 2xl:px-8">
                <div className="lg:grid lg:grid-cols-[60%_40%] lg:gap-8">
                    <div className="px-3 py-4 lg:px-0 lg:py-0">
                        ...
                        {pasoActual === 2 && (
                            <Paso2 datos={datos} setDatos={setDatos} errores={errores} />
                        )}
                        {pasoActual === 3 && (
                            <Paso3
                                datos={datos}
                ...
                <div className="lg:mx-auto lg:max-w-7xl lg:px-6 2xl:px-8">
                    <div className="flex gap-2 px-3 py-3 lg:max-w-3xl">
                        <button
                            ...
                            onClick={handleAtras}
                            disabled={guardando}
                            className="rounded-lg border-2 border-slate-300 bg-white px-4 py-3 text-sm font-semibold text-slate-700 transition-colors hover:bg-slate-100 disabled:opacity-50"
                        >
                        ...
                        <button
                            ...
                            className="flex flex-1 items-center justify-center gap-2 rounded-lg bg-linear-to-br from-slate-800 to-slate-950 px-4 py-3 text-sm font-bold text-white shadow-md transition-transform hover:scale-[1.01] disabled:cursor-not-allowed disabled:opacity-40 disabled:hover:scale-100"
                        >
                    ...
                    <div className="w-full max-w-md overflow-hidden rounded-2xl bg-white shadow-2xl">
                        ...
                        <div className="border-t border-slate-200 bg-slate-50 px-4 py-3">
                            <button
                                ...
                                className="w-full rounded-lg bg-linear-to-br from-slate-800 to-slate-950 px-4 py-2.5 text-sm font-semibold text-white shadow-md"
                            >
                    ...
                    {datos.fotos.map((url, idx) => (
                        ...
                        >
                            ...
                            <button
                                ...
                                className="absolute right-1 top-1 flex h-6 w-6 items-center justify-center rounded-full bg-black/70 text-white hover:bg-rose-500"
                            >
