...
export default function TabContacto({
  ...
  const InputTelefono = ({ value, onChange }: { value: string; onChange: (v: string) => void }) => {
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-3 2xl:gap-4 lg:items-start">
      ...
      <div className="bg-white border-2 border-slate-300 rounded-xl overflow-hidden"
        ...
        <div className="px-4 py-3 flex items-center gap-2.5"
          ...
          <Phone className="w-4 h-4 lg:w-4 lg:h-4 2xl:w-5 2xl:h-5 text-slate-300 shrink-0" />
        ...
        <div className="p-4 lg:p-3 2xl:p-4 space-y-4 lg:space-y-3 2xl:space-y-4">
          ...
          {mostrarNombreSucursal && (
            <CampoInput
              ...
              icono={<MapPin className="w-4 h-4 lg:w-3.5 lg:h-3.5 2xl:w-4 2xl:h-4 text-blue-600" />}
            >
          ...
          <div className="grid grid-cols-1 gap-4 lg:gap-3 2xl:gap-4">
            <CampoInput
              label="Teléfono"
              icono={<Phone className="w-4 h-4 lg:w-3.5 lg:h-3.5 2xl:w-4 2xl:h-4 text-blue-600" />}
            >
              <InputTelefono
          ...
          <div className="grid grid-cols-1 gap-4 lg:gap-3 2xl:gap-4">
            <CampoInput
              ...
              icono={<Mail className="w-4 h-4 lg:w-3.5 lg:h-3.5 2xl:w-4 2xl:h-4 text-blue-600" />}
            >
              <div className="flex items-center h-11 lg:h-10 2xl:h-11 bg-slate-100 rounded-lg px-4 lg:px-3 2xl:px-4"
                style={ESTILO_INPUT}>
                <input
            ...
            {mostrarSitioWeb && (
              <CampoInput
                ...
                icono={<Globe className="w-4 h-4 lg:w-3.5 lg:h-3.5 2xl:w-4 2xl:h-4 text-blue-600" />}
              >
                <div className="flex items-center h-11 lg:h-10 2xl:h-11 bg-slate-100 rounded-lg px-4 lg:px-3 2xl:px-4"
                  style={ESTILO_INPUT}>
                  <input
      ...
      <div className="bg-white border-2 border-slate-300 rounded-xl overflow-hidden"
        ...
        <div className="px-4 py-3 flex items-center gap-2.5"
          style={{ background: 'linear-gradient(135deg, #1e293b, #334155)' }}>
          <Share2 className="w-4 h-4 lg:w-4 lg:h-4 2xl:w-5 2xl:h-5 text-slate-300 shrink-0" />
