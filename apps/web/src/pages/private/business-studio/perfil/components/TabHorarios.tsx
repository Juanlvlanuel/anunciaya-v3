    ...
    return (
        <div className="space-y-4 lg:space-y-5">
            ...
            <div className="space-y-3 lg:space-y-0 lg:flex lg:items-center lg:justify-between lg:gap-3">
                ...
                {/* Selector de días */}
                <div className="flex gap-1.5 lg:gap-2 overflow-x-auto scrollbar-hide flex-1">
                    {diasSemana.map((nombreDia, indiceVisual) => {
                        ...
                        return (
                            <button
                                ...
                                className={`
                                    relative shrink-0 min-w-[60px] lg:min-w-14 2xl:min-w-[72px] px-3 lg:px-3 2xl:px-4 py-2.5 lg:py-2 2xl:py-3 rounded-lg lg:rounded-lg 2xl:rounded-xl text-sm lg:text-xs 2xl:text-sm font-bold transition-all
                            ...
                            >
                                {!esSeleccionado && (
                                    <div className="absolute -top-1 -right-1 flex items-center justify-center">
                                        {estaAbierto ? (
                                            <Check className="w-3.5 lg:w-3 2xl:w-4 h-3.5 lg:h-3 2xl:h-4 text-green-600 bg-white rounded-full border border-green-600" strokeWidth={3} />
                                        ) : (
                                            <X className="w-3.5 lg:w-3 2xl:w-4 h-3.5 lg:h-3 2xl:h-4 text-slate-400 bg-white rounded-full border border-slate-300" strokeWidth={3} />
                                        )}
                                    </div>
                                )}
                                {nombreDia}
                ...
                {/* Botones rápidos */}
                <div className="flex gap-2 lg:gap-2 2xl:gap-3 shrink-0">
                    <button
                        type="button"
                        onClick={duplicarHorario}
                        className="flex-1 lg:flex-none flex items-center justify-center gap-2 lg:gap-1.5 2xl:gap-2 px-4 lg:px-3 2xl:px-5 py-2.5 lg:py-2 2xl:py-3 text-sm lg:text-xs 2xl:text-sm font-bold bg-slate-600 hover:bg-slate-700 text-white rounded-lg lg:rounded-lg 2xl:rounded-xl transition-all shadow-sm"
                    >
                        <Copy className="w-4 lg:w-3.5 2xl:w-4 h-4 lg:h-3.5 2xl:h-4" />
                        <span>Duplicar</span>
                    </button>
                    <button
                        type="button"
                        onClick={establecer24_7}
                        className="flex-1 lg:flex-none flex items-center justify-center gap-2 lg:gap-1.5 2xl:gap-2 px-4 lg:px-3 2xl:px-5 py-2.5 lg:py-2 2xl:py-3 text-sm lg:text-xs 2xl:text-sm font-bold bg-blue-600 hover:bg-blue-700 text-white rounded-lg lg:rounded-lg 2xl:rounded-xl transition-all shadow-sm"
                    >
                        <Clock className="w-4 lg:w-3.5 2xl:w-4 h-4 lg:h-3.5 2xl:h-4" />
                        <span>24/7</span>
                    </button>
                </div>
            </div>
            ...
            <div className="space-y-4 lg:space-y-3 2xl:space-y-4">
                ...
                <div className="bg-slate-100 rounded-xl lg:rounded-lg 2xl:rounded-xl p-5 lg:p-4 2xl:p-5">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3 lg:gap-2 2xl:gap-3">
                            <Clock className="w-5 lg:w-4 2xl:w-5 h-5 lg:h-4 2xl:h-5 text-blue-600" />
                            <span className="text-base lg:text-sm 2xl:text-base font-bold text-slate-700">Estado del día</span>
                        </div>
                        <label className="flex items-center gap-3 lg:gap-2 2xl:gap-3 cursor-pointer group">
                            <input
                                ...
                                className="sr-only"
                            />
                            <div className="relative w-14 lg:w-12 2xl:w-14 h-7 lg:h-6 2xl:h-7">
                                <div className="absolute inset-0 bg-slate-400 group-has-checked:bg-green-500 rounded-full transition-all"></div>
                                <div className="absolute top-1 left-1 w-5 lg:w-4 2xl:w-5 h-5 lg:h-4 2xl:h-5 bg-white rounded-full shadow-md transition-all group-has-checked:translate-x-7 lg:group-has-checked:translate-x-6 2xl:group-has-checked:translate-x-7"></div>
                            </div>
                ...
                {horarioDia.abierto ? (
                    <>
                        ...
                        <div className="bg-slate-100 rounded-xl lg:rounded-lg 2xl:rounded-xl p-5 lg:p-4 2xl:p-5">
                            <div className="grid grid-cols-2 gap-6 lg:gap-5 2xl:gap-6">
                                <div>
                                    <span className="block text-sm lg:text-xs 2xl:text-sm font-bold text-slate-700 mb-2.5 lg:mb-2 2xl:mb-2.5">
                                        Hora de Apertura
                                    </span>
                                    <TimePicker
                        ...
                        <div className="space-y-3">
                            {/* Checkbox */}
                            <label className="flex items-center gap-2.5 lg:gap-2 2xl:gap-2.5 cursor-pointer">
                                <input
                                    ...
                                    className="w-5 lg:w-4 2xl:w-5 h-5 lg:h-4 2xl:h-5 text-amber-600 border-2 border-slate-300 rounded focus:ring-2 focus:ring-amber-200 transition-all"
                                />
                                <Coffee className="w-5 lg:w-4 2xl:w-5 h-5 lg:h-4 2xl:h-5 text-amber-600" />
                    ...
                    <div className="py-16 lg:py-10 2xl:py-16 text-center bg-slate-100 rounded-xl lg:rounded-lg 2xl:rounded-xl">
                        <X className="w-14 lg:w-10 2xl:w-14 h-14 lg:h-10 2xl:h-14 text-slate-400 mx-auto mb-4 lg:mb-3 2xl:mb-4" strokeWidth={1.5} />
                        <p className="text-base lg:text-sm 2xl:text-base text-slate-600 font-semibold">Este día permanecerá cerrado</p>
                    </div>
                )}
    ...
    if (isMobile) {
        ...
        return (
            <div className="flex items-center gap-1.5 lg:gap-1 2xl:gap-1.5">
                ...
                <span className="text-lg lg:text-base 2xl:text-lg font-bold text-slate-400">:</span>
                ...
                <select
                    ...
                    className="w-16 lg:w-14 2xl:w-16 text-center text-base lg:text-sm 2xl:text-base font-medium py-2 lg:py-1.5 2xl:py-2 px-2 lg:px-1.5 2xl:px-2 bg-slate-50 border-2 border-slate-300 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-100 focus:outline-none transition-all"
                >
    ...
    return (
        <div className="relative flex-1">
            <input
                ...
                className="w-full text-center text-base lg:text-sm 2xl:text-base font-medium py-2 lg:py-1.5 2xl:py-2 px-3 lg:px-2 2xl:px-3 bg-slate-50 border-2 border-slate-300 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-100 focus:outline-none transition-all"
            />
            <div className="absolute right-1.5 lg:right-1 2xl:right-1.5 top-1/2 -translate-y-1/2 flex flex-col gap-0.5">
                <button type="button" onClick={increment} className="w-5 lg:w-4 2xl:w-5 h-4 lg:h-3 2xl:h-4 rounded bg-slate-200 hover:bg-blue-200 border border-slate-300 flex items-center justify-center transition-all">
                    <svg className="w-3 lg:w-2.5 2xl:w-3 h-3 lg:h-2.5 2xl:h-3 text-slate-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path d="M5 15l7-7 7 7" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                </button>
                <button type="button" onClick={decrement} className="w-5 lg:w-4 2xl:w-5 h-4 lg:h-3 2xl:h-4 rounded bg-slate-200 hover:bg-blue-200 border border-slate-300 flex items-center justify-center transition-all">
                    <svg className="w-3 lg:w-2.5 2xl:w-3 h-3 lg:h-2.5 2xl:h-3 text-slate-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
function WheelTimePicker({ hora, minutos, periodo, onHoraChange, onMinutosChange, onPeriodoChange }: WheelTimePickerProps) {
    ...
    return (
        <div className="relative bg-slate-50 border-2 border-slate-300 rounded-xl p-2.5 overflow-hidden touch-none shadow-sm">
