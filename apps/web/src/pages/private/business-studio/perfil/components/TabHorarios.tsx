...
import { Clock, Coffee, Copy, Check, X, ChevronDown } from 'lucide-react';
                    ...
                    {dropdownAbierto && createPortal(
                        ...
                        >
                            <button type="button"
                                ...
                                className={`w-full px-4 py-2.5 text-center text-base lg:text-sm 2xl:text-base font-medium cursor-pointer ${p === 'AM' ? 'bg-indigo-100 text-indigo-700 font-semibold' : 'bg-white text-slate-700 hover:bg-slate-200'}`}>
                                AM
                            </button>
                            <button type="button"
                                onClick={() => { handleChange(h, m, 'PM'); setDropdownAbierto(false); }}
                                className={`w-full px-4 py-2.5 text-center text-base lg:text-sm 2xl:text-base font-medium cursor-pointer ${p === 'PM' ? 'bg-indigo-100 text-indigo-700 font-semibold' : 'bg-white text-slate-700 hover:bg-slate-200'}`}>
                                PM
                            </button>
                        </div>,
                        document.body
