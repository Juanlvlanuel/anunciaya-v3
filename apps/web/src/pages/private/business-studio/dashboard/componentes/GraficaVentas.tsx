    ...
    <div className={`bg-white h-full ${embedded
      ...
      {!embedded && (
        <div className="flex items-center justify-between mb-3 lg:mb-2 2xl:mb-3">
          <div>
            ...
            <p className="text-sm lg:text-[11px] 2xl:text-sm font-medium text-slate-600">Evolución diaria</p>
          </div>
      ...
      {datosGrafica.length > 0 ? (
        ...
        <div className="h-[220px] flex flex-col items-center justify-center text-slate-600">
          ...
          <p className="text-sm lg:text-[11px] 2xl:text-sm font-medium">No hay datos de ventas para este periodo</p>
        </div>
      )}
    </div>
  );
