...
export default function SistemaNiveles({
  ...
  return (
    ...
    >
      ...
      <div
        className="flex items-center justify-between px-3 lg:px-4 py-2 lg:py-2 lg:h-[40px] 2xl:h-auto"
        style={{ background: 'linear-gradient(135deg, #1e293b, #334155)' }}
      >
        <div className="flex items-center gap-2 lg:gap-2.5">
          <div
            className="w-7 h-7 lg:w-7 lg:h-7 2xl:w-9 2xl:h-9 rounded-lg flex items-center justify-center shrink-0"
