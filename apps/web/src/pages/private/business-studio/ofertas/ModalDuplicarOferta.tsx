        ...
        >
            <div className="space-y-4 lg:space-y-3 2xl:space-y-4">
                ...
                <div className="bg-slate-50 rounded-lg p-3 lg:p-2 2xl:p-3 border border-slate-200">
                    <p className="text-xs text-slate-500 mb-2 lg:mb-1.5 2xl:mb-2">Oferta a duplicar:</p>
                    ...
                    {sucursales.map((sucursal) => {
                        ...
                        return (
                            <button
                                ...
                                className={`w-full p-3 lg:p-2 2xl:p-3 rounded-lg border-2 transition-all text-left ${estaSeleccionada
