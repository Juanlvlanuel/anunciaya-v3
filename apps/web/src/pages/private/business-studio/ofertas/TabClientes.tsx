...
export function TabClientes({
    ...
    if (modoEdicion) {
        return (
            <div className="p-4 lg:p-4 2xl:p-4 flex flex-col gap-3 lg:gap-2.5 2xl:gap-3 h-full">
                <div className="flex items-center gap-2.5 lg:gap-2 2xl:gap-2.5 px-3.5 py-2.5 lg:px-3 lg:py-2 2xl:px-3.5 2xl:py-2.5 bg-slate-200 rounded-lg">
                    ...
                    <p className="text-sm lg:text-xs 2xl:text-sm text-slate-700 font-semibold">
                ...
                <div className="flex-1 min-h-0 overflow-y-auto bg-white rounded-lg border-2 border-slate-300">
                    {cargandoAsignados ? (
                        ...
                        <p className="p-6 text-sm lg:text-xs 2xl:text-sm text-slate-600 font-medium text-center">
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <p className="text-sm lg:text-xs 2xl:text-sm font-bold text-slate-800 truncate">{cliente.nombre}</p>
                                    ...
                                    <div className={`px-2 py-0.5 rounded-lg flex items-center gap-1 shrink-0 ${badge.clases}`}>
                                        ...
                                        <span className="text-sm lg:text-xs 2xl:text-sm font-bold">{badge.label}</span>
                                    </div>
                                </button>
                            );
                        })
        ...
        <div className="p-4 lg:p-4 2xl:p-4 flex flex-col gap-3 lg:gap-2.5 2xl:gap-3 h-full">
            ...
            <div className="flex gap-1 p-1 bg-slate-100 rounded-lg border-2 border-slate-300 shrink-0">
                <button
                    ...
                    className={`flex-1 h-9 lg:h-8 2xl:h-9 rounded-md text-sm lg:text-xs 2xl:text-sm font-semibold cursor-pointer transition-colors ${
                    ...
                    {clientesSeleccionados.map((id) => {
                        ...
                        return (
                            <span
                                ...
                                className="inline-flex items-center gap-1 pl-2.5 pr-1 py-1 rounded-full bg-blue-100 border-2 border-blue-300 text-blue-700 text-xs font-semibold max-w-[12rem]"
                            >
            ...
            <div className="flex items-center justify-between">
                ...
                <button
                    ...
                    className="text-sm lg:text-xs 2xl:text-sm font-semibold text-blue-600 hover:text-blue-700 cursor-pointer"
                >
                ...
                {cargando ? (
                    ...
                    clientesFiltrados.map(cliente => (
                        ...
                        >
                            ...
                            {nivelesActivos && (
                            <span className={`text-xs lg:text-[11px] 2xl:text-xs font-bold uppercase px-2 py-0.5 lg:px-1.5 lg:py-0.5 2xl:px-2 rounded-full border-2 shrink-0 ${
            ...
            <p className="text-sm lg:text-xs 2xl:text-sm text-slate-600 font-medium shrink-0">
                    ...
                    usuariosBuscados.map((u) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className="text-sm lg:text-xs 2xl:text-sm font-semibold text-slate-800 truncate">{u.nombre} {u.apellidos}</p>
                                </div>
                                <span className={`text-xs lg:text-[11px] 2xl:text-xs font-bold uppercase px-2 py-0.5 lg:px-1.5 lg:py-0.5 2xl:px-2 rounded-full border-2 shrink-0 ${
