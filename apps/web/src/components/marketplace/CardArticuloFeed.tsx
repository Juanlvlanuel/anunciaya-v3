    ...
    return (
        ...
        >
            ...
            {fotos.length > 0 ? (
                <div
                    ref={galeriaRef}
                    className={`group relative ${modoModal ? 'h-56 lg:h-64' : esVideoActual ? 'aspect-[4/5] lg:aspect-[5/4]' : 'aspect-[4/3] lg:aspect-[5/4]'} w-full overflow-hidden bg-slate-100 lg:cursor-pointer touch-pan-y`}
