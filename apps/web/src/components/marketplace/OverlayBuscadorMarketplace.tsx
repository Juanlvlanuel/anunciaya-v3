                                ...
                                <div className="flex flex-wrap gap-2">
                                    {populares.map((termino) => (
                                        <button
                                            ...
                                            onClick={() => ejecutarBusqueda(termino)}
                                            className="rounded-full border-2 border-slate-200 bg-slate-50 px-3 py-1.5 text-sm font-medium text-slate-700 hover:border-teal-400 hover:bg-teal-50 hover:text-teal-700"
                                        >
                                            {termino}
                                        </button>
                                    ))}
                                ...
                                {sugerencias.map((titulo, idx) => (
                                    <li key={`${titulo}-${idx}`}>
                                        <button
                                            ...
                                            className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-left text-sm text-slate-800 hover:bg-slate-100"
                                        >
                                            <Search
