/**
 * ChipInputList.tsx (MarketPlace composer)
 * ==========================================
 * Input + chips para listas cortas (zonas). Réplica 1:1 del de Servicios
 * — vive aquí en `components/marketplace/composer/` para mantener el
 * composer MP autocontenido.
 *
 * Si en un futuro se decide centralizar componentes compartidos del
 * composer, mover ambos (este + el de Servicios) a `components/composer/`
 * y actualizar imports en los dos lados.
 *
 * Ubicación: apps/web/src/components/marketplace/composer/ChipInputList.tsx
 */
