...
export function ComposerMarketplace({
    ...
    useEffect(() => {
        ...
        if (!estaIntacto) bloquear('composer-marketplace');
        else desbloquear('composer-marketplace');
        return () => desbloquear('composer-marketplace');
    }, [estaIntacto]);
    ...
    useEffect(() => {
        ...
        const handler = (e: MouseEvent) => {
            ...
            if (target.closest('[data-menu-toggle-camara-mp]')) return;
                    ...
                    <div className="relative shrink-0 px-4 pt-3 pb-[calc(0.75rem+env(safe-area-inset-bottom,0px))] border-t-2 border-slate-200">
                        ...
                        {menuCamaraAbierto && (
                            ...
                            >
                                ...
                                <button
                                    type="button"
                                    data-testid="composer-mp-camara-foto"
                                ...
                                <button
                                    type="button"
                                    data-testid="composer-mp-camara-video"
