        ...
        <div>
            ...
            <div className="flex gap-2">
                <input
                    ...
                    className="flex-1 rounded-xl border-[1.5px] border-slate-300 bg-white px-4 py-2.5 text-[15px] text-slate-900 placeholder:text-slate-500 font-medium outline-none focus:border-sky-500"
                />
                <button
                    type="button"
