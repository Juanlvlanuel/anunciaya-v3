// WizardSteps.tsx — componentes de los 3 pasos + constantes + iconos
import { useState } from "react";

/* ------------------------------------------------------------ types */
export type CategoryId =
  | "hogar" | "cuidados" | "eventos" | "belleza" | "empleo" | "otros";
export type ModalityId = "presencial" | "remoto" | "hibrido";
...
export type WizardData = {
  ...
  budgetMax: string;
  zones: string[];
  confirms: { legal: boolean; truthful: boolean; coord: boolean };
};
...
export const MODALITIES: { id: ModalityId; title: string; desc: string }[] = [
...
export const CONFIRMATIONS: { id: keyof WizardData["confirms"]; title: string; desc: string }[] = [
  {
    id: "legal",
...
export function Icon({ name }: { name: string }) {
  ...
  switch (name) {
    case "hogar":    return <svg {...p}><path d="M3 11 12 4l9 7v9a1 1 0 0 1-1 1h-5v-6h-6v6H4a1 1 0 0 1-1-1Z"/></svg>;
    case "cuidados": return <svg {...p}><path d="M12 21s-7-4.35-7-10a4 4 0 0 1 7-2.65A4 4 0 0 1 19 11c0 5.65-7 10-7 10Z"/></svg>;
    case "eventos":  return <svg {...p}><path d="M3 21 9 9l6 6Z"/><path d="m13 7 4 4"/><path d="M15 5h4M17 3v4M21 9v4"/></svg>;
    case "belleza":  return <svg {...p}><path d="M12 2 14 8l6 .5-4.5 4 1.5 6L12 15l-5 3.5L8.5 12.5 4 8.5 10 8Z"/></svg>;
    case "empleo":   return <svg {...p}><rect x="3" y="7" width="18" height="13" rx="2"/><path d="M8 7V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>;
    case "otros":    return <svg {...p}><circle cx="12" cy="12" r="9"/><path d="M9.5 9.5a2.5 2.5 0 1 1 4 2c-.7.5-1.5 1-1.5 2"/><circle cx="12" cy="17" r=".5" fill="currentColor"/></svg>;
    case "camera":   return <svg {...p}><path d="M4 7h3l2-2h6l2 2h3a1 1 0 0 1 1 1v11a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V8a1 1 0 0 1 1-1Z"/><circle cx="12" cy="13" r="4"/></svg>;
    ...
    case "info":     return <svg {...p}><circle cx="12" cy="12" r="9"/><path d="M12 8v.01M12 12v4"/></svg>;
    case "sparkles": return <svg {...p}><path d="M5 3v4M3 5h4M19 13v4M17 15h4M12 4 13.5 8 17.5 9.5 13.5 11 12 15 10.5 11 6.5 9.5 10.5 8Z"/></svg>;
    default:         return null;
  }
}
        ...
        <div className="field" style={{ marginBottom: 0 }}>
          ...
          >
            ...
            <div className="body">
              ...
              <p>
                Sube tu pedido al top del feed de Clasificados y lo marca con etiqueta naranja.
...
/* ============================================================
   PASO 2 — Detalles
   ============================================================ */
export function Step2({ data, set }: StepProps) {
      ...
      <div>
        <div className="field">
          <span className="field-label">
            Fotos <span className="extra">(opcional · máx 6)</span>
          </span>
                ...
                >
                  {filled ? (
                    <button
                      type="button"
                      className="remove"
                      onClick={(e) => { e.stopPropagation(); togglePhoto(i); }}
                    >
                      <Icon name="x" />
                    </button>
                  ) : (
        ...
        <div className="field">
          ...
          <p className="field-help">
            Cuánto estás dispuesto a pagar. Los prestadores cotizan dentro de ese rango.
          </p>
        ...
        <div className="field" style={{ marginBottom: 0 }}>
          ...
          <p className="field-help">
            Mínimo 1, máximo 10. Las colonias o zonas donde puedes dar/recibir el servicio.
          </p>
            ...
            <div className="chip-row">
              {data.zones.map((z) => (
                <span key={z} className="chip">
                  {z}
                  <button onClick={() => removeZone(z)} aria-label={`Quitar ${z}`}>
                    <Icon name="x" />
                  </button>
                </span>
              ))}
          ...
          <div className="info-card">
            ...
            <div>
              ...
              <p>
                Tu coordenada exacta nunca se publica. El feed mostrará a los vecinos una zona
                aproximada con un offset de unos cientos de metros.
              </p>
            </div>
          </div>
        </div>
...
/* ============================================================
   ...
   ============================================================ */
export function Step3({ data, set }: StepProps) {
    ...
    <div className="step-grid">
      <div className="rail">
        ...
        <p className="subtitle">
          Así se verá tu publicación. Si algo no está bien, regresa con el botón Atrás.
        </p>
      </div>
      <div>
        <div className="field">
          ...
          <div className={"preview-card" + (data.urgent ? " urgent" : "")}>
            <div className="cover">
              <span className="badge-solicito">
                {data.urgent ? "⚡ Urgente · Solicito" : "Solicito"}
              </span>
            </div>
            <div className="body">
              ...
              <p className="preview-desc">
                {data.description || "Tu descripción aparecerá aquí."}
              </p>
              <div className="zones">
                {data.zones.length === 0 ? (
          ...
          <div style={{ display: "grid", gap: 10 }}>
            {CONFIRMATIONS.map((c) => (
              <div
                ...
                onClick={() =>
                  set({ confirms: { ...data.confirms, [c.id]: !data.confirms[c.id] } })
                }
              >
                <div className="box"><Icon name="check" /></div>
                <div className="body">
        ...
        <div className="footer-note">
          Al publicar, tu anuncio queda activo por <b>30 días</b>. Si pasa ese tiempo sin
          interacción se pausa automáticamente y puedes reactivarlo cuando quieras desde{" "}
